package com.devpaulo.list_games.entities;

import jakarta.persistence.*;

import java.util.Objects;

@Entity//confiugara a classe java para que seja equivalente a uma tabela do banco relacional
@Table(name = "tb_game")
public class Game {

    //atributos de um jogo
    @Id
